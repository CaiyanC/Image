...
export default function AssetSearch() {
  ...
  const search = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : '素材检索失败')
    } finally {
      setLoading(false)
    }
  }
