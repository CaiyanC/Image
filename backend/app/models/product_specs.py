...
class ProductSpecs(Base):
    ...
    capacity: Mapped[str] = mapped_column(Text, nullable=False, default="")
    ...
    power: Mapped[str] = mapped_column(Text, nullable=False, default="")
    technical_advantages: Mapped[str] = mapped_column(Text, nullable=False, default="")
